...
riot.tag2('serialize-sexp', '<section-3 title="Function: SERIALIZE-SEXP"> <section-4 title="Description"> <div class="contents"> <p>object を文字列に変換し stream に書き出します。</p> <p>内部的には <a href="#page03/serialize-sexp-internal">serialize-sexp-internal</a> をコールして処理しています。</p> </div> </section-4> </section-3>', '', '', function(opts) {
});
...
riot.tag2('serialize-xml', '<section-3 title="Function: SERIALIZE-XML"> <div class="contents"> <pre>serialize-xml object stream &optional serialization-state</pre> </div> <section-4 title="Description"> <div class="contents"> <p><a href="#page03/serialize-xml-internal">serialize-xml-internal</a> をコールして object を文字列に変換します。</p> <p>文字列に変換したものを stream に出力します。</p> </div> </section-4> <section-4 title="Arguments"> <div class="contents"> <table class="table"> <thead> <tr> <th>Name</th> <th>Description</th> </tr> </thead> <tbody> <tr> <th>object</th> <td></td> </tr> <tr> <th>stream</th> <td></td> </tr> <tr> <th>serialization-state</th> <td>初期値: (make-serialization-state)</td> </tr> </tbody> </table> </div> </section-4> </section-3>', '', '', function(opts) {
});

riot.tag2('page01', '<section-header title="S-SERIALIZATION"> <h2 class="subtitle"> データ/オブジェクトをシリアライズ/デシリアライズするためのライブラリです。。 </h2> </section-header> <section class="section"> <div class="container"> <h1 class="title">Usage</h1> <div class="contents"> <p>XML へのシリアライズ、XMLからのシリアライズを以下のように行います。</p> </div> <section-4 title="シリアライズ"> <div class="contents"> <pre>(<a href="#page03/serialize-xml">serialize-xml</a> objects out (serialization-state pool))</pre> </div> </section-4> <section-4 title="デシリアライズ"> <div class="contents"> <pre>(<a href="#page03/deserialize-xml">deserialize-xml</a> in (serialization-state pool))</pre> </div> </section-4> </div> </section> <section-3 title="生い立ち"> <div class="contents"> <p> <a href="https://bitbucket.org/skypher/cl-prevalence">CL-PREVALENCE</a> から切り出したものです。 </p> <p> <a href="https://bitbucket.org/skypher/cl-prevalence">CL-PREVALENCE</a> からフォークした 拙作 の <a href="https://github.com/yanqirenshi/upanishad">UPANISHAD</a> を書く上で一旦切り出しました。 </p> </div> </section-3> <section-footer></section-footer>', '', '', function(opts) {
});
